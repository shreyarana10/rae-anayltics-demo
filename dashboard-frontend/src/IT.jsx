...
export default function IT({ filter, searchTerm, setSearchTerm }) {
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/customer-retentation`)
      .then((res) =>
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/employee-evolution`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/sales-per-month`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/project-per-month`)
      .then((res) =>
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/client-project`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/joining-date-people`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/it/urgency-openproject`)
  ...
  const handleEmployeeClick = useCallback(async (emp) => {
    ...
    try {
      const res = await axios.get(
        `${API_BASE}/it/employee-projects/${emp.user_id}`,
      );
