...
export default function Industrial({ filter, searchTerm, setSearchTerm }) {
  ...
  // Add this function inside your industrial component
  ...
  // Process customer data to show unique customers with aggregated data
  // Process customer data to show unique customers with aggregated data
    ...
    customerRetention.forEach((row) => {
      ...
      if (!customerMap.has(key)) {
        customerMap.set(key, {
          ...
          total_projects: 0,
          total_amount: 0,
          projects: [], // Store all projects for this customer
        });
      }
  ...
  // useEffect(() => {
  //   axios
  //     .get("http://localhost:5000/api/industrial/project-subproject-data")
  //     .then((res) => {
