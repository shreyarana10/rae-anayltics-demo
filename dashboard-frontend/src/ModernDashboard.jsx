...
// filter, setFilter, searchTerm, setSearchTerm are injected by Layout.jsx
export default function ModernDashboard({ filter, setFilter, searchTerm, setSearchTerm }) {
  ...
  // --- SEARCH PERSISTENCE ---
  useEffect(() => {
    if (setSearchTerm) localStorage.setItem('csarae_search', searchTerm);
  }, [searchTerm]);
  ...
  const recentProjects = useMemo(() => {
    return [...projects].sort((a, b) => b.project_id - a.project_id).slice(0, 5);
  }, [projects]);
