...
export default function Building({ filter, searchTerm, setSearchTerm }) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/customer-retentation")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/employee-evolution")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/sales-per-month")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/project-per-month")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/client-project")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/purple-closed")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/joining-date-people")
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/monthly-total")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/building/urgency-openproject")
  ...
  const handleEmployeeClick = useCallback(async (emp) => {
    ...
    try {
      const res = await axios.get(
        `http://localhost:5000/api/building/employee-projects/${emp.user_id}`,
      );
