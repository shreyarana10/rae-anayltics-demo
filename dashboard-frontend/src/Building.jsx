...
export default function Building({ filter, searchTerm, setSearchTerm }) {
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/customer-retentation`)
      .then((res) =>
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/employee-evolution`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/sales-per-month`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/project-per-month`)
      .then((res) =>
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/client-project`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/purple-closed`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/joining-date-people`)
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/monthly-total`)
      .then((res) => {
        const monthNames = [
          "Jan",
          "Feb",
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE}/building/urgency-openproject`)
  ...
  const handleEmployeeClick = useCallback(async (emp) => {
    ...
    try {
      const res = await axios.get(
        `${API_BASE}/building/employee-projects/${emp.user_id}`,
      );
